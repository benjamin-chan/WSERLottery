...
* `r sum(dfHat$tickets[sampLottery$runner] == 5)` applicants with 5 tickets were selected (`r format(100 * sum(dfHat$tickets[sampLottery$runner] == 5) / distn[5], digits=2)`%)
...
```{r ObsCompare, results='asis', eval=FALSE}
