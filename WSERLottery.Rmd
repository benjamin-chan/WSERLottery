...
probWSER <- c(4.7, 9.3, 17.6, 32.2, 54.0, 78.8)  # Selection probabilities from WSER
...
```{r, echo=FALSE, results="asis"}
scenarios <- aggLottery[, .N, list(confail.0, confail.1, confail.2, confail.3, confail.4, confail.5)]
...
print(xtable(mostLikely, digits=c(rep(0, 8), 5)), type="html", include.rownames=FALSE)
```
