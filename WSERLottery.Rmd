...
# ---------------------
#    5 folks with 64 tickets, each has a 90.867% chance of getting drawn
#   15 folks with 32 tickets, each has a 69.811% chance of getting drawn
#   71 folks with 16 tickets, each has a 45.064% chance of getting drawn
#  168 folks with  8 tickets, each has a 25.853% chance of getting drawn
#  368 folks with  4 tickets, each has a 13.900% chance of getting drawn
#  620 folks with  2 tickets, each has a  7.202% chance of getting drawn
# 2281 folks with  1 ticket , each has a  3.672% chance of getting drawn
distn <- c(2281, 620, 368, 168, 71, 15, 5)  # Number of entrants for each ticket count
probWSER <- c(3.672, 7.202, 13.900, 25.853, 45.064, 69.811, 90.867)  # Selection probabilities from WSER
spots <- 270  # Number of spots up for grabs
size <- 1E5  # Use 1E5 for production, 1E3 for testing
dateLottery <- as.Date("2015-12-05", format="%Y-%m-%d")  # Random number seed; use lottery date
```
...
```{r PlotProbabilities, echo=FALSE, results='hide', fig.keep='none'}
...
```{r PlotFrequencies, echo=FALSE, results='hide', fig.keep='none'}
## Number of entrants
...
simsum[, c("Number of tickets", "N", "Mean", "EV")]
#
