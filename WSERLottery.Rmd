...
# Input data on the number of entrants for each ticket count.
# 
...
#
# Selection probabilities from WSER
# ---------------------------------
#  **Use this table** for input data on the selection probabilities to compare
#  **my simulations to.
...
size <- 1E3  # Use 1E5 for production, 1E3 for testing
dateLottery <- as.Date("2014-12-06", format="%Y-%m-%d")
